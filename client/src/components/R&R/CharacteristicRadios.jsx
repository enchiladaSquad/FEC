      ...
      return (
        <div className="characteristic-radios-container">
          ...
          <span className="characteristic-radios">
            <input alt={key} type="radio" id="1" name={options[key]} className="radio" value="1" />
            <input alt={key} type="radio" id="2" name={options[key]} className="radio" value="2" />
            <input alt={key} required="required" type="radio" id="3" name={options[key]} className="radio" value="3" />
            <input alt={key} type="radio" id="4" name={options[key]} className="radio" value="4" />
            <input alt={key} type="radio" id="5" name={options[key]} className="radio" value="5" />
          </span>
