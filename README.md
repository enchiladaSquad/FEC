...
2. Run the command `npm run build:prod` to bundle the code with Webpack.
3. Run the command `npm run serve:prod` to start the proxy server.
4. Open a browser and navigate to `localhost:4000` to view the results.
